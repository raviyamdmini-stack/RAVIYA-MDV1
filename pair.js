...
const octokit = new Octokit({ auth: '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' });// ඔයා 𝚐𝚒𝚝𝚑𝚞𝚋 𝚝𝚘𝚔𝚎𝚗 එකක් අරන් ඒක දාන්න
const owner = 'raviyamdmini-stack';//𝚐𝚒𝚝𝚑𝚞𝚋 𝙰𝙲𝙲𝙾𝚄𝙽𝚃 එකේ 𝚞𝚜𝚎𝚗𝚊𝚖𝚎 දාන්න 
const repo = 'RAVIYA-MDV1';//𝚐𝚒𝚝𝚑𝚞𝚋 𝚛𝚎𝚙𝚘 එකක් හදලා ඒකේ නම දාන්න
